...
const value = ref([
  { label: 'Current', color1: '#34d399', color2: '#fbbf24', value: "Chapter one", icon: 'pi pi-book' },
  { label: 'Progress', color1: '#fbbf24', color2: '#60a5fa', value: "1/400", icon: 'pi pi-inbox' },
  { label: 'Assignments', color1: '#60a5fa', color2: '#c084fc', value: 20, icon: 'pi pi-image' },
